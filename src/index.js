...
const create_btn_el = document.querySelector('#create')
let todos = []
...
function CreateNewTodo(){
    ...
    todos.unshift(item); //adds new todo at the beggining of the todos array
...
{/* <div class="item">
                ...
                <div class="actions">
                    <button class="mateiral-icons"><span class="material-symbols-outlined">
                        edit
                        </span></button>
                    <button class="material-icons remove-btn"><span class="material-symbols-outlined">
                        do_not_disturb_on
                        </span></button>
                </div>
            </div> */}
